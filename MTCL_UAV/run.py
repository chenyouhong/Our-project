...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='UAV anomaly detection')

    # basic config
    parser.add_argument('--is_training', type=int, default=1, help='status')
    parser.add_argument('--model', type=str, default='MTCL',
                        help='model name, options: [MTCL]')
    parser.add_argument('--model_id', type=str, default="test")

    # data loader
    parser.add_argument('--data', type=str, default='FD', help='dataset type: FD, ALFA_ad')
    parser.add_argument('--root_path', type=str, default='./dataset/FD2/', help='root path of the data file')
